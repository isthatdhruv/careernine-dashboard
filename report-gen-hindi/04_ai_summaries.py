...
if args.export_prompts:
    ...
    for idx in range(start_index, end_index):
        ...
        ai_summary_prompt = (
            f"Generate a summary of a student's profile under 200 words , designed to help them gain confidence and a better understanding of themselves. summary should be in hindi keeping in mind that the translation should be in generalised hindi that is used nowadays speakingly . can use someurdu words too that is used in daily life . Also Some words are to be in English in Brackets like Personality , Intelligence , Learning Style etc , career pathway etc . "
        ...
        learning_style_prompt = (
            f"Generate a concise, motivational summary of a student's profile in no more than 160 words. summary should be in hindi keeping in mind that the translation should be in generalised hindi that is used nowadays speakingly . can use someurdu words too that is used in daily life ."
